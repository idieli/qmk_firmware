...
[_NUM] = LAYOUT_planck_mit(
    TO(_BASE),  _______,  KC_7,     KC_8,     KC_9,     _______,  _______,  KC_LT,    KC_PLUS,  KC_ASTR,  KC_CIRC,  KC_DEL,
    _______,    KC_0,     KC_4,     KC_5,     KC_6,     _______,  _______,  KC_EQL,   KC_MINS,  KC_SLSH,  _______,  _______,
    KC_BSPC,    KC_DOT,   KC_1,     KC_2,     KC_3,     _______,  _______,  KC_GT,    _______,  KC_PERC,  _______,  _______,
